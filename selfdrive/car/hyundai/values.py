...
class CAR(Platforms):
  ...
  HYUNDAI_AZERA_5TH_GEN = HyundaiPlatformConfig(
    ...
    CarSpecs(mass=1650, wheelbase= 2.700000047683716, steerRatio=14.5),
    flags=HyundaiFlags.CLUSTER_GEARS,
  )
  ...
  KIA_K7_YG_20 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia Cadenza 2019-21", "Advanced Smart Cruise Control", car_parts=CarParts.common([CarHarness.hyundai_k]))],
