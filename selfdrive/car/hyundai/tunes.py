...
def set_lat_tune(tune, name, max_lat_accel=2.5, FRICTION=.1):
  ...
  if name == LatTunes.ATOM:
    ...
    tune.atom.lqr.a = [0., 1., -0.226, 1.21]
    tune.atom.lqr.b = [-2.15e-04, 4.10]
    tune.atom.lqr.c = [1., 0.]
    tune.atom.lqr.k = [-125.0, 465.0]
    tune.atom.lqr.l = [0.31, 0.32]      
    ...
    tune.lqr.ki = LqrKi
    tune.lqr.a = [0., 1., -0.226, 1.21]
    tune.lqr.b = [-2.15e-04, 4.10]
    tune.lqr.c = [1., 0.]
    tune.lqr.k = [-125.0, 465.0]
    tune.lqr.l = [0.31, 0.32]
