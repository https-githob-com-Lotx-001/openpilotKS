...
class TestHyundaiFingerprint:
  ...
  def test_platform_code_ecus_available(self, subtests):
    ...
    no_eps_platforms = CANFD_CAR | {CAR.KIA_SORENTO, CAR.KIA_OPTIMA_G4, CAR.KIA_OPTIMA_G4_FL, CAR.KIA_CADENZA_YG, CAR.KIA_OPTIMA_H,
                                    CAR.KIA_OPTIMA_H_G4_FL, CAR.HYUNDAI_SONATA_LF, CAR.HYUNDAI_TUCSON, CAR.GENESIS_G90, CAR.HYUNDAI_AZERA_5TH_GEN, CAR.GENESIS_G80, CAR.HYUNDAI_ELANTRA}
