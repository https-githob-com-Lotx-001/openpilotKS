...
FW_VERSIONS = {
  ...
  CAR.HYUNDAI_AZERA_5TH_GEN: {
    #(Ecu.fwdRadar, 0x7d0, None): [
      #b'\xf1\x00HG__ SCC FHCUP      1.1 96400-3V100         ',
    #],
    #(Ecu.eps, 0x7d4, None): [
      #b'\xf1\x00HG  MDPS C 1.00 1.02 56310G8510\x00 4IGSC103',
    #],
    (Ecu.fwdCamera, 0x7c4, None): [
       b'\xf1\x00VF LKAS 1.00 1.00 -141219',
    ],
  },
  CAR.HYUNDAI_GENESIS: {
    (Ecu.fwdCamera, 0x7c4, None): [
  ...
  CAR.KIA_K7_YG_20: {
    (Ecu.fwdRadar, 0x7d0, None): [
      b'\xf1\x00YG__ SCC F-CU-      1.00 1.00 99110F6000         ',
    ],
    (Ecu.fwdCamera, 0x7c4, None): [
      b'\xf1\x00YG  MFC  AT MES LHD 1.00 1.05 99211F6000 200926',
      b'\xf1\x00YG  MFC  AT KOR LHD 1.00 1.05 99211F6000 200926',
    ],
  },
